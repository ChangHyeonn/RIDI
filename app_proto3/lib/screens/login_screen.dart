  ...
  Widget build(BuildContext context) {
    return Consumer<TaskProvider>(
      builder: (context, taskProvider, child) {
        ...
        final adjustedFontSize = baseFontSize * (0.5 + safeFontSize);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 48 * (0.5 + safeFontSize)),
                    
                    // 아이디 입력 필드
                    TextFormField(
                      controller: _usernameController,
                      style: TextStyle(fontSize: 16 * (0.5 + safeFontSize)),
                      decoration: InputDecoration(
                        labelText: '아이디',
                        labelStyle: TextStyle(fontSize: 14 * (0.5 + safeFontSize)),
                    ...
                    SizedBox(height: 32 * (0.5 + safeFontSize)),
